...
declare class API {
   ...
   */
    ...
    */
    ...
    getOnlineCustomServiceList:()=>any 
    ...
    * @param {Number} isOthers 是否为6.4.5表之外的其它物流公司(0-否，1-是，无该字段默认为不是其它物流公司)
    */
